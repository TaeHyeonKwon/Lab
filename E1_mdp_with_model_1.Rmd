...
\begin{definition}
Definition : It shows the usefulness of obtaining information according to the predicted distribution by using the feature that the actual distribution and the predicted distribution are different after assuming the actual distribution.
\end{definition}

\vspace{20pt}

$$H(P,Q) = - \sum_{x \in \textbf{x}}P_X(x)logQ_X(x)$$
